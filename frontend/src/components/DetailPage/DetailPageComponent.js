...
export default function DetailPlace() {
  ...
  const fetchPlaceDetail = () => {
    return fetch(`${API_ENDPOINT}/api/place/${params.placeId}`)
        ...
        <div className="row text-center">
          ...
          <div className="col-sm-4">
            <div className="contact-detail-box">
              ...
              <h4>Website</h4>
              <p className="p-website">{placeDetail.website}</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="row form-row align-items-center">
            <div className="col-3">
              <div className="img-square">
                <img
                  src={photo_url(placeDetail.photos[0].photo_reference)}
                  alt="..."
                  className="img-cover"
                />
              </div>
            ...
            <div className="col-6">
              <div className="row form-row align-items-end mb-2">
                <div className="col-7">
                  <div className="img-square">
                    <img
                      src={photo_url(placeDetail.photos[1].photo_reference)}
                      alt="..."
                      className="img-cover"
                    />
                  </div>
                ...
                <div className="col-5">
                  <div className="img-square">
                    <img
                      src={photo_url(placeDetail.photos[2].photo_reference)}
                      alt="..."
                      className="img-cover"
                    />
                  </div>
              ...
              <div className="row form-row">
                <div className="col-5">
                  <div className="img-square">
                    <img
                      src={photo_url(placeDetail.photos[3].photo_reference)}
                      alt="..."
                      className="img-cover"
                    />
                  </div>
                ...
                <div className="col-7">
                  <div className="img-square">
                    <img
                      src={photo_url(placeDetail.photos[4].photo_reference)}
                      alt="..."
                      className="img-cover"
                    />
                  </div>
            ...
            <div className="col-3">
              <div className="img-square">
                <img
                  src={photo_url(placeDetail.photos[5].photo_reference)}
                  alt="..."
                  className="img-cover"
                />
              </div>
              ...
              <div className="media g-mb-30 media-comment">
                ...
                <div className="media-body u-shadow-v18 g-bg-secondary g-pa-30">
                  <div className="g-mb-15">
                    <h5 className="h6 g-color-gray-dark-v1 mb-0">
                      {review.author_name}
                    </h5>
